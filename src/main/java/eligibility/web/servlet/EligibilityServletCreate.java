...
import eligibility.service.EligibilityException;
...
public class EligibilityServletCreate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EligibilityServletCreate() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		} catch (ClassNotFoundException | EligibilityException e) {
			e.printStackTrace();
